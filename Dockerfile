...
# ==============================================================================
FROM nvidia/cuda:12.8.1-cudnn-devel-ubuntu22.04@sha256:ad6d59a3bbf3e82c1c849c9ac09cfc2a3e0bbb8655042fd899be6681b3fe2a85 AS build-stage
...
# Install pip and venv for the system's python3
# The CUDA image is based on Ubuntu and comes with Python 3.
